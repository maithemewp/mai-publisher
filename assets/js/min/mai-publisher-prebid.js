/******/ (() => { // webpackBootstrap
/*!*******************************************!*\
  !*** ./assets/js/mai-publisher-prebid.js ***!
  \*******************************************/
...
if (window.googletag && googletag.apiReady) {
  ...
  var prebidTimeout = 2000;
  googletag.cmd.push(function () {
    // Loop through maiPubAdsVars getting key and values.
    for (var id in ads) {
      // Define ad slot.
      var slot = googletag.defineSlot('/23001026477/' + maiPubAdsVars['gamDomain'] + '/' + id, ads[id].sizes, 'mai-ad-' + id).addService(googletag.pubads()).setTargeting(refreshKey, refreshvalue);

      /**
       * Define size mapping.
       * If these breakpoints change, make sure to update the breakpoints in the mai-publisher.css file.
       */
      slot.defineSizeMapping(googletag.sizeMapping().addSize([1024, 768], ads[id].sizesDesktop).addSize([640, 480], ads[id].sizesTablet).addSize([0, 0], ads[id].sizesMobile).build());
    }
