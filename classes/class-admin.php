...
class Mai_Publisher_Admin {
	...
	function add_description( $current_screen ) {
		...
		$descriptions = [
			...
			'before_entry'           => __( 'Use this location to display large ads before a single entry, before the title. The available space is limited by the content width. Typically uses leaderboard or billboard.', 'mai-publisher' ),
			'before_entry_content'   => __( 'Use this location to display ads before single entry content, after the title. The available space is limited by the content width. Typically uses leaderboard or billboard.', 'mai-publisher' ),
			'entries'                => __( 'Use this location to display ads in between rows of archive entries. The available space is limited by the content width. Typically uses billboard or leaderboard.', 'mai-publisher' ),
			'entries_wide'           => __( 'Use this location to display large ads in between rows of archive entries. Typically uses billboard-wide or leaderboard-wide.', 'mai-publisher' ),
			...
			'comments'               => __( 'Use this location to display ads in between comments. Typically uses billboard or medium-rectangle', 'mai-publisher' ),
			'after_loop'             => __( 'Use this location to display large ads after archive entries. Typically uses leaderboard-wide or billboard-wide.', 'mai-publisher' ),
			'before_sidebar_content' => __( 'Use this location to display ads before the sidebar content. Typically uses rectangle-medium.', 'mai-publisher' ),
			'after_sidebar_content'  => __( 'Use this location to display ads after the sidebar content. Typically uses rectangle-medium.', 'mai-publisher' ),
			'before_footer'          => __( 'Use this location to display large ads before the footer. Typically uses leaderboard-wide or billboard-wide.', 'mai-publisher' ),
			'after_footer'           => __( 'Use this location to display large ads fixed to the footer of browser window. Typically uses leaderboard-wide.', 'mai-publisher' ),
		];
